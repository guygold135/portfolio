...
export const translations = {
  he: {
    ...
    pricing: {
      ...
      customQuoteNote:
        "אם הדרישות שלכם לא נופלות בדיוק על אחת מהחבילות, אתם מוזמנים ליצור איתנו קשר ולקבל הצעת מחיר ספציפית.",
      plans: [
        {
          id: "landing",
          name: "דף נחיתה",
        ...
        },
        {
          ...
          features: [
            "עד 5 עמודים מעוצבים עם מעבר מהיר וחלק",
        ...
        },
        {
          ...
          features: [
            "עד 10 עמודים מעוצבים עם מעבר מהיר וחלק",
            "חיבור למערכת ניהול מידע עצמאית",
            "אוטומציות מתקדמות",
    ...
    contact: {
      ...
      unsurePlanOption: "לא בטוח/ה בחבילה",
      selectedPlanUnsure: "חבילה שנבחרה: לא בטוח/ה בחבילה",
      nameLabel: "שם / שם העסק",
      phoneLabel: "מספר וואטסאפ",
      phonePlaceholder: "0521234567",
      phoneInvalid: "הזינו מספר טלפון ישראלי תקין (ספרות בלבד, 9–10 ספרות).",
      submit: "אני רוצה סקיצה בחינם לעסק שלי",
      submitting: "שולח...",
      submitError: "שליחת הטופס נכשלה. נסו שוב או צרו קשר ישירות.",
  ...
  en: {
    ...
    pricing: {
      ...
      customQuoteNote:
        "If your needs don't fit exactly into one of the packages, you're welcome to contact us for a specific custom quote.",
      plans: [
        {
          id: "landing",
          name: "Landing site",
          ...
          features: [
            ...
            "30 days of support and full warranty",
        ...
        },
        {
          ...
          features: [
            "Up to 5 designed pages with fast, smooth transitions",
        ...
        },
        {
          ...
          features: [
            "Up to 10 designed pages with fast, smooth transitions",
            "Independent CMS integration",
    ...
    contact: {
      ...
      unsurePlanOption: "Not sure about the package",
      selectedPlanUnsure: "Selected package: Not sure yet",
      nameLabel: "Name / business name",
      phoneLabel: "WhatsApp number",
      phonePlaceholder: "0521234567",
      phoneInvalid: "Enter a valid Israeli phone number (digits only, 9–10 digits).",
